...
export const trainingSeasonspotify =
  'https://open.spotify.com/artist/0nsTvhODP9ZYbxC0KePYSQ?si=wv7aAe_MR7mMbBe7V9eFuQ';
...
export const sonRobSpotify =
  'https://open.spotify.com/artist/25MdZkOsHPiWaMvqo2FTxn?si=4W20mS9EQ3uInhy6Oj9M9w';
export const sonRobAppleMusic = '';
export const sonRobInstagram = '';
...
export const greenbearddSpotify =
  'https://open.spotify.com/artist/7tmBkT4rSpUWMWUM9wZ6y7?si=xJTjRia1T8uewp_SAAoHuA';
export const greenbearddAppleMusic = '';
export const greenbearddInstagram = '';
